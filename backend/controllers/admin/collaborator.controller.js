            ...
            if (user === null) {
                ...
                let mailOptions = {
                    ...
                    html: ejs.render('<table border="0" cellspacing="0" cellpadding="0" align="center" style="border-collapse:collapse">\n' +
                        ...
                        '                                        </div>\n' +
                        '                                        <br>\n' +
                        '                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#4c649b;color:#fff">\n' +
                        '                                            <tbody>\n' +
                        '                                            <tr>\n' +
                        '                                                <td style="text-transform:uppercase;padding:12px 10px">Thông tin đăng nhập của bạn là:</td>\n' +
                        '                                            </tr>\n' +
                        '                                            </tbody>\n' +
                        '                                        </table>\n' +
                        ...
                        '                                                <td style="font-size:11px;font-family:LucidaGrande,tahoma,verdana,arial,sans-serif;padding:10px;background-color:#f2f2f2;border-left:1px solid #ccc;border-right:1px solid #ccc;border-top:1px solid #ccc;border-bottom:1px solid #ccc">\n' +
                        '                                                    <span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">\n' +
                        '                                                        <a href="http://163.44.193.183:9000/admin/login">\n' +
                        '                                                            http://163.44.193.183:9000\n' +
                        '                                                        </a>\n' +
                        '                                                    </span>\n' +
                        '                                                </td>\n' +
                        '                                            </tr>\n' +
                        ...
                        '                                                            <tbody>\n' +
                        '                                                            <tr>\n' +
                        '                                                                <td style="border-collapse:collapse;border-radius:2px;text-align:center;display:block;border:solid 1px #344c80;background:#4c649b;padding:12px 16px 12px 16px">\n' +
                        '                                                                    <a href="https://www.facebook.com/recover/code/?u=100007969296560&amp;n=452869&amp;s=23&amp;exp_locale=vi_VN&amp;redirect_from=button" style="color:#3b5998;text-decoration:none;display:block" target="_blank">\n' +
                        '                                                                        <center>\n' +
                        '                                                                            <font size="3">\n' +
                        ...
                        '                                    <a href="mailto:levanviet_t58@hus.edu.vn" style="color:#3b5998;text-decoration:none" target="_blank">\n' +
                        '                                        levanviet_t58@hus.edu.vn\n' +
                        '                                    </a>\n' +
