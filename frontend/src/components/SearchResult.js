    ...
    <main className="main main--phone-756">
      ...
      <div className="result-board__calendar">
        ...
        <div className="result-list">
          ...
          <div className="result-list__content"><div className="result-list-item js-toggle">
          ...
          <div className="form-search__content">
            <div className="form-search__radio form-group-radio">
              <p>
                ...
                <label className="js-slideToggle" htmlFor="motChieu" data-target=".slideToggle-motChieu">Một chiều</label>
              </p>
              <p>
                <input type="radio" id="khuHoi" name="radio-group" />
                <label className="js-slideToggle" htmlFor="khuHoi" data-target=".slideToggle-khuHoi">Khứ hồi</label>
              </p>
            </div>
            <div className="forms-group slideToggle-motChieu slideToggleContent" style={{display: 'block'}}>
            <div className="form-group">
              <label className="form-title">Ngày khởi hành</label>
              <input className="datepicker form-control form-control-datepicker" defaultValue="03/04/2020" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group form-group--number dropdown js-dropdown">
              ...
              <div className="form-group form-group--number dropdown js-dropdown">
                ...
                <div className="forms-group slideToggle-khuHoi slideToggleContent" style={{display: 'none'}}>
                <div className="form-group">
                  <label className="form-title">Ngày khởi hành</label>
                  <input className="datepicker form-control form-control-datepicker" defaultValue="03/04/2020" />
                </div>
                <div className="form-group">
                  ...
                  <input className="datepicker form-control form-control-datepicker" defaultValue="07/04/2020" />
                </div>
                <div className="form-group">
                  <label className="form-title">Điểm khởi hành</label>
                  <select className="form-control">
