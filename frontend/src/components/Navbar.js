...
const Navbar = () => {
    return (
        <div className="banner-search-page js-lazy-load" data-src="images/banner-search-page.png" data-type="background-image">
            <header className="header"><img className="header__logo" src={imagesUrl + "logo-white.png"} alt="logo"/>
                <ul className="header__nav d-flex justify-content-between h-100">
                    ...
                    <li className="header__nav-item">
                        <a href="/">
                            <div className="img-wrap"><img className="img-full-height" src={imagesUrl + "icon_plan.svg"} alt="wrap"/></div><span className="header__user-name">Minh Tu</span>
                        </a>
                    </li>
                    <li className="header__nav-item">
