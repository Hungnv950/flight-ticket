...
const Navbar = () => {
    return (
      <header className="header">
        ...
        <img className="header__logo" src={imagesUrl + "logo.png"} />
        <ul className="header__nav">
          ...
          <li className="header__nav-item header__account">
            <a href="#">
              <div className="img-wrap"><img className="img-full-height" src={imagesUrl + "avatar-demo2.png"} /></div>
              <span className="header__user-name">Minh Tu</span>
            </a>
          </li>
          <li className="header__nav-item">
            <a className="header__cart" href="/my_cart.html">
