...
const Navbar = () => {
    return (
        <header className="header"><img className="header__logo" src={imagesUrl + "logo.png"} alt="logo" />
            <ul className="header__nav d-flex justify-content-between h-100">
                <li className="header__nav-item">
                    <a className="hneader-f-w" href="# ">
                ...
                <li className="header__nav-item">
                    <a href="# ">
                        <div className="img-wrap"><img className="img-full-height" src={imagesUrl + "icon_plan.svg"} alt="img wrap"/></div><span className="header__user-name">Minh Tu</span>
                    </a>
                </li>
                <li className="header__nav-item">
