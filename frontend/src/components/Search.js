			...
			<React.Fragment>
				...
				>
					<header className="header">
						<img alt="img" className="header__logo" src={imagesUrl + "logo-white.png"} />
						<ul className="header__nav d-flex justify-content-between h-100">
							...
							<li className="header__nav-item">
								<a href="# ">
									<div className="img-wrap"><img alt="img" className="img-full-height" src={imagesUrl + "icon_plan.svg"} /></div>
									...
									<div className="tab__content-item js-tab-content-item one-way active">
										<div className="form__content">
											<div className="form__address">
												<div className="form-group js-dropdown dropdown">
												...
												<div className="form-group">
													...
													<div className="group-input">
														<input className="form-control" type="text" defaultValue="14/03/2020" />
														<div className="icon-search">
															<svg xmlns="http://www.w3.org/2000/svg" width={15} height={15} viewBox="0 0 15 15">
																...
																<g>
																	<g>
																		<g>
																			<path fill="#fff" d="M0 15V0h15v15z" />
																		</g>
																		<g clipPath="url(#88zga)">
																			<g>
																				<g>
																					<g>
																						<path fill="#989898" d="M10.723 6.152a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M12.656 1.172h-.761V.586a.586.586 0 1 0-1.172 0v.586H8.057V.586a.586.586 0 1 0-1.172 0v.586H4.248V.586a.586.586 0 1 0-1.172 0v.586h-.732A2.346 2.346 0 0 0 0 3.516v9.14A2.346 2.346 0 0 0 2.344 15h4.482a.586.586 0 1 0 0-1.172H2.344a1.173 1.173 0 0 1-1.172-1.172v-9.14c0-.647.526-1.172 1.172-1.172h.732v.586a.586.586 0 1 0 1.172 0v-.586h2.637v.586a.586.586 0 1 0 1.172 0v-.586h2.666v.586a.586.586 0 1 0 1.172 0v-.586h.761c.646 0 1.172.525 1.172 1.172v3.34a.586.586 0 1 0 1.172 0v-3.34a2.346 2.346 0 0 0-2.344-2.344z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M11.455 13.828a2.376 2.376 0 0 1-2.373-2.373 2.376 2.376 0 0 1 2.373-2.373 2.376 2.376 0 0 1 2.373 2.373 2.376 2.376 0 0 1-2.373 2.373zm0-5.918a3.549 3.549 0 0 0-3.545 3.545A3.549 3.549 0 0 0 11.455 15 3.549 3.549 0 0 0 15 11.455a3.549 3.549 0 0 0-3.545-3.545z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M12.305 10.87h-.264v-.616a.586.586 0 1 0-1.172 0v1.201c0 .324.262.586.586.586h.85a.586.586 0 1 0 0-1.172z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M8.174 6.152a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M5.625 8.701a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M3.076 6.152a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M3.076 8.701a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M3.076 11.25a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M5.625 11.25a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																					<g>
																						<path fill="#989898" d="M5.625 6.152a.586.586 0 1 1 1.172 0 .586.586 0 0 1-1.172 0z" />
																					</g>
																				</g>
																			</g>
																		</g>
											...
											<div className="form__passenger">
												<div className="form-group dropdown js-dropdown">
													...
													<ul className="dropdown__list">
														<li className="dropdown__item"><span>1 hành khách</span></li>
														<li className="dropdown__item"><span>2 hành khách</span></li>
														<li className="dropdown__item"><span>3 hành khách</span></li>
													</ul>
												</div>
												<div className="form-group dropdown js-dropdown">
										...
										<div className="form__content">
											<div className="form__address">
												<div className="form-group js-dropdown dropdown">
													...
													<ul className="dropdown__list">
														<li className="dropdown__item"><span>Ha Noi</span></li>
														<li className="dropdown__item"><span>Vinh</span></li>
														<li className="dropdown__item"><span>Ho Chi Minh</span></li>
													</ul>
												</div>
												<div className="form-group js-dropdown dropdown">
													<label className="form-title">Điểm đến</label>
					...
					<div className="offer">
						...
						<div className="offer__content">
							<div className="offer__item">
								<img alt="img" src={imagesUrl + "gift.png"} />
								<p className="offer__item-content">Phần thưởng hấp dẫn</p>
							</div>
							<div className="offer__item">
								<img alt="img" src={imagesUrl + "sale.png"} />
								<p className="offer__item-content">Giảm giá hấp dẫn</p>
							</div>
							<div className="offer__item">
								<img alt="img" src={imagesUrl + "group-user.png"} />
						...
						<br />Vui lòng&nbsp;<a href="# ">đăng nhập</a>&nbsp;hoặc&nbsp;<a href="# ">đăng kí</a>&nbsp;tài khoản để hưởng các ưu đãi đặc biệt cho thành viên từ ThankTrip
					</p>
						</div>
					</div>
