													...
													<div className="form-group js-dropdown dropdown dropdown--select-location">
														...
														<ul className="dropdown__list">
															<li className="dropdown__item">
																<div className="city"><span>Hà Nội&nbsp;</span><span className="font-weight-bold">(HNN)</span></div>
																<span className="country">Việt Nam</span>
															</li>
															<li className="dropdown__item">
																<div className="city"><span>Hồ Chí Minh&nbsp;</span><span className="font-weight-bold">(TSN)</span></div>
																<span className="country">Việt Nam</span>
															</li>
															<li className="dropdown__item">
																<div className="city"><span>Đồng Hới&nbsp;</span><span className="font-weight-bold">(DHN)</span></div>
																<span className="country">Việt Nam</span>
															</li>
														</ul>
													</div>
