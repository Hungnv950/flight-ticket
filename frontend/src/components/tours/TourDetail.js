                ...
                <div className="tour-detail">
                    <div className="container">
                        ...
                        <div className="tour-detail__title">
                            <div className="title">
                                <h1>{tour.title}</h1>
                                <p><span>Khỏi hành ngày:</span><span className="text-blue-sky">&nbsp;21/09/2019</span>
                                </p>
                            </div>
                                    ...
                                    <div className="card card-tour-detail">
                                        <div className="tab js-tab tab-tour-detail tab-style">
                                            ...
                                            <div className="tab__content">
                                                <div
                                                    className={(this.isActiveTab(1) ? "active" : "") + " tab__content-item js-tab-content-item tab-tour-info"}>
                                                                        ...
                                                                        <Carousel breakPoints={sliderBreakPoints}>
                                                                            <div className="day">
                                                                                <div className="day__top">
                                                                                    <span
                                                                                        className="seating">Còn 15 Chỗ</span>
                                                                                ...
                                                                                <div className="day__bottom">
                                                                                    <span
                                                                                        className="price">2.000.000 đ</span>
                                                                                    <a className="link">
                                                                                        <svg
                                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                                            width={22} height="15.14"
                                                                                            viewBox="0 0 22 15.14">
                                ...
                                <div className="col-xl-3 col-lg-4 col-12 col-custom">
                                    <div className="card card-countdown-start-tour">
                                        ...
                                        <p className="time"><span
                                            className="time__title">Khỏi hành ngày:&nbsp;</span><span
                                            className="text-blue-sky">21/09/2019</span></p>
                                        ...
                                        <p className="note">Chia sẽ Tour và nhận ngay 100,000đ cho mỗi lượt book thành
                                            công</p>
                                    </div>
